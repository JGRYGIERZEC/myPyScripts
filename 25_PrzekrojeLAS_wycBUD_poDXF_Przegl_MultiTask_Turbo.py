...
def generate_overview_dxf(polygons, start_id, output_name="przegladowka.dxf"):
    ...
    for i, poly in enumerate(polygons):
        ...
        # poly.exterior.coords zwraca listę krotek (x, y)
        ...
        # Używamy centroidu z Shapely
        centroid = poly.centroid
        
        # 3. Dodanie tekstu ID
        # color 2 = żółty w standardzie AutoCAD (ACI)
        ...
        # Ustawienie punktu wstawienia na środek tekstu (Middle Center)
...
def worker_process_polygon(poly_data):
    ...
    try:
        ...
        aci_colors = [1, 2, 3, 4, 5, 6] # Podstawowe kolory CAD
        offsets = np.arange(0, 4.3, 0.3)
        buffer = 0.05
        ...
        # Zapis i aktualizacja raportu o dokładny czas zapisu
...
def main():
    ...
    # Wczytanie poligonów (uproszczone dla czytelności)
    ...
    # --- IMPLEMENTACJA GENEROWANIA PLIKU PRZEGLADOWKA.DXF ---
    if polygons:
